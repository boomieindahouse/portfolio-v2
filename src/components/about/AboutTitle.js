        ...
        <div className="h-[500px] lg:h-[600px] bg-primary flex items-center px-4 sm:px-6 xl:px-8" style={{
            ...
            <div className="container mx-auto">
                <div className='h-[200px] xl:h-[300px]'>
                    <h1 className="text-[40pt] md:text-7xl lg:text-[66pt] xl:text-[100pt] font-semibold text-white leading-[55px] xl:leading-tight text-left md:text-left mt-28 xl:mt-10">
                        Pawitsanat
                        <br />
